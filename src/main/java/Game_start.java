...
public interface Game_start {
    ...
    static void dotField(int y, int x, char dot) {
        fieldg [y][x] = dot;
    }
    //Ход человева
    ...
    static boolean MoveAiLineHorisont(int v, int h, char dot) {
    ...
    static boolean MoveAiLineVertical(int v, int h, char dot) {
    ...
    static boolean MoveAiDiaUp(int v, int h, char dot) {
    ...
    static boolean MoveAiDiaDown(int v, int h, char dot) {
    ...
    static boolean checkMove(int y, int x) {
    ...
    static int checkDiaUp(int v, int h, char dot) {
        int count=0;
        for (int i = 0, j = 0; j < SIZE_WIN; i--, j++) {
    ...
    static int checkDiaDown(int v, int h, char dot) {
        int count=0;
        for (int i = 0; i < SIZE_WIN; i++) {
    ...
    static int checkLineHorisont(int v, int h, char dot) {
        int count=0;
    ...
    static int checkLineVertical(int v, int h, char dot) {
        int count=0;
